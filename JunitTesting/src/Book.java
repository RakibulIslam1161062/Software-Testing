...
public class Book implements Comparable<Book> {
    ...
    public void setPublishDate(LocalDate publishedOn) {
    	this.publishedOn = publishedOn;
    }
    ...
    public Boolean startedReadingOn(LocalDate startedOn) {
    ...
    public Boolean finishedReadingOn(LocalDate finishedOn) {
